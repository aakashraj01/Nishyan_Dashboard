      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col px-3 pt-3 pb-2 gap-3 rounded-[8px] bg-white">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 px-4 py-[6px] border border-[#D9D9D9] text-[#808080] rounded w-full max-w-[250px]">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-[6px] px-3 py-[6px] border border-[#D9D9D9] text-[#4D4D4D] rounded min-w-[75px]">
                Sort{" "}
                <Image src={updown} alt="updown icon" width={14} height={14} />
              </button>
            ...
            <table className="min-w-full">
              ...
              <thead className="text-[#4D4D4D]">
                <tr className="bg-[#F2F2F2] rounded-lg overflow-hidden">
                  ...
                  <th className="px-3 py-[10px] flex items-center text-left text-sm font-medium tracking-wider">
                    Order date <FaCaretDown />
                  </th>
                  <th className="px-3 py-[10px] text-right text-sm font-medium tracking-wider">
                    Order amount
                  </th>
                  <th className="px-3 py-[10px] flex text-right text-sm font-medium tracking-wider justify-end gap-x-1">
                    Transaction fees <GoInfo className="relative top-0.5"/>
                  </th>
                </tr>
              </thead>
              <tbody className="bg-white px-3 divide-y divide-[#E6E6E6]">
                {tableData.map((row, index) => (
                  <tr className="text-sm" key={index}>
                    ...
                    <td className="px-3 py-[10px] whitespace-nowrap text-[#4D4D4D] text-right">
                      {row.orderAmount}
                    </td>
