    ...
    return (
        <div className='px-4 py-[9px] bg-[#F2F2F2] space-x-2 flex grow items-center rounded-md'>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_5730_2526)">
    ...
    <nav className='bg-white flex w-full items-center px-8 py-3 space-x-4 sticky top-0 z-10 border-b'>
        ...
        <section className='flex space-x-3 grow justify-end'>
            ...
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='hover:cursor-pointer'>
                <g clipPath="url(#clip0_5730_2537)">
